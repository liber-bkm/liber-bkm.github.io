...
- `/guide/*`: adding, searching, editing, attachments, tags-folders, import, automation, sync, profiles, web-ui, static-export, link-health, completions (from `docs.md` + `Project-readme.md`)
...
- `/reference/cli/`: full `liber --help` mirror (v0.7.1)
- `/dev/*`: internals (data model, ingest, mutations, search, automation, attachments, archive backends, profiles/sync, web UI, link health), split from `dev-docs.md`
